...
VALUES ('admin', '$2a$12$YrgRqbei9Zy6IBaQut0mf.9fraiAn9U6lOlq/mFUL0Br1OkStViBe', 'VienQT@ptit.edu.vn', 'Quản Trị Viên', 'admin');

-- Insert sample test student (password: "Matkhau123@")
INSERT INTO users (username, password, email, full_name, role, student_id, class, department, entry_year)
VALUES ('B22CN123', '$2y$12$qjRb9Bs9SKw6UCnYrxf7wOHB5KpiEYuKiYLrGb6ccSkcirx.KvJBC', 'AnNV.B22CN123@stu.ptit.edu.vn', 'Nguyễn Văn An', 'student', 'B22CN123', 'D22CN01', 'Công nghệ thông tin', 2022);
